...
import common.models.requests._
...
class AuthImpl(
  ...
  private def notAuthorisedPage: Result = Redirect(common.controllers.routes.ErrorController.notAuthorised)

  private def serviceUnavailablePage: Result = Redirect(common.controllers.routes.ErrorController.serviceUnavailable)
