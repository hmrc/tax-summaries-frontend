...
import controllers.auth.{AuthAction, AuthenticatedRequest, SelfAssessmentAction}
...
class IndexController @Inject()(
  ...
  def authorisedIndex: Action[AnyContent] = (authAction andThen selfAssessmentAction).async {
