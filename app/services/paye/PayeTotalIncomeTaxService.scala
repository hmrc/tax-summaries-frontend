...
object PayeTotalIncomeTaxService extends PayeTotalIncomeTaxService {
  override val atsService = PayeAtsService
}

trait PayeTotalIncomeTaxService {
  ...
  private[services] def totalIncomeConverter(atsData: AtsData): PayeTotalIncomeTax = {
