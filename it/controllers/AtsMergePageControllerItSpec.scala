...
import utils.{FileHelper, IntegrationSpec, LoginPage}
...
class AtsMergePageControllerItSpec extends IntegrationSpec {
  ...
  "/income-before-tax" must {
    ...
    lazy val url = s"/annual-tax-summary/paye/main?ref=PORTAL&id=${LoginPage.agentToken(generatedSaUtr.utr)}"

    lazy val backendUrlSa = s"/taxs/$generatedSaUtr/ats-list"

    lazy val backendUrlPaye = s"/taxs/$generatedNino/2019/2020/paye-ats-data"
