...
merge.page.paye.ivuplift.text=I weld eich Crynodeb Treth Blynyddol TWE, bydd angen i chi
merge.page.paye.ivuplift.link.text=osod diogelwch ychwanegol.
...
ats.select_tax_year.sa.label={0} to {1} for Self Assessment
ats.select_tax_year.paye.label={0} to {1} for PAYE
ats.select_tax_year.no_ats.label={0} to {1} for a general Annual Tax Summary
