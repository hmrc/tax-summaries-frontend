...
trait BaseSpec
  ...
  protected def allYears(currentTaxYearSA: Int, currentTaxYearPAYE: Int, currentGovSpendYear: Int): Seq[Int] = {
    val taxYears = Seq(currentTaxYearSA, currentTaxYearPAYE, currentGovSpendYear)
