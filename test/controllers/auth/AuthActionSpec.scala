...
class AuthActionSpec extends UnitSpec with OneAppPerSuite with MockitoSugar {
  ...
  val ggSignInUrl =
    "http://localhost:9025/bas-gateway/sign-in?continue=http://localhost:9217/annual-tax-summary&continue=http%3A%2F%2Flocalhost%3A9217%2Fannual-tax-summary&origin=tax-summaries-frontend"
