...
import services.paye.{PayeAtsService, PayeGovernmentSpendService}
...
class PayeGovernmentSpendControllerSpec extends UnitSpec with GuiceOneAppPerSuite with MockitoSugar with I18nSupport {
  ...
  trait TestController extends PayeGovernmentSpendController {

    override lazy val governmentSpendService: PayeGovernmentSpendService = mock[PayeGovernmentSpendService]
    override lazy val auditService: AuditService = mock[AuditService]
    lazy val atsService: PayeAtsService = mock[PayeAtsService]
