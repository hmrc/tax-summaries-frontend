...
import controllers.auth.paye.PayeFakeAuthAction
...
class PayeNicsSummaryControllerSpec extends UnitSpec with GuiceOneAppPerSuite with MockitoSugar with I18nSupport {
  ...
  trait TestController extends PayeNicsController {
