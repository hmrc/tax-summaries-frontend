...
class PayeTotalIncomeTaxControllerSpec extends UnitSpec with GuiceOneAppPerSuite with MockitoSugar with I18nSupport {
  ...
  trait TestController extends PayeTotalIncomeTaxController {
    ...
    override lazy val totalIncomeTaxService = mock[PayeTotalIncomeTaxService]
