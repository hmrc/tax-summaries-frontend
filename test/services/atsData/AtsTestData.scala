      ...
      DataHolder(
        Some(
          Map(
            ...
            "scottish_advanced_rate_tax"         -> Amount.gbp(2600),
            "scottish_advanced_income"           -> Amount.gbp(2700),
            "scottish_additional_rate_tax"       -> Amount.gbp(2800),
            "scottish_additional_income"         -> Amount.gbp(2900),
