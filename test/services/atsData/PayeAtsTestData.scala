...
object PayeAtsTestData {
  ...
  val payeGovernmentSpendViewModel = PayeGovernmentSpend(
    2018,
    List(
      ("Welfare", SpendData(Amount(451, "GBP"), 23.5)),
      ("Health", SpendData(Amount(388, "GBP"), 20.2)),
      ("StatePensions", SpendData(Amount(246, "GBP"), 12.8)),
      ("Education", SpendData(Amount(226, "GBP"), 11.8)),
      ("Defence", SpendData(Amount(102, "GBP"), 5.3)),
      ("NationalDebtInterest", SpendData(Amount(98, "GBP"), 5.1)),
      ("Transport", SpendData(Amount(83, "GBP"), 4.3)),
      ("PublicOrderAndSafety", SpendData(Amount(83, "GBP"), 4.3)),
      ("BusinessAndIndustry", SpendData(Amount(69, "GBP"), 3.6)),
      ("GovernmentAdministration", SpendData(Amount(40, "GBP"), 2.1)),
      ("HousingAndUtilities", SpendData(Amount(31, "GBP"), 1.6)),
      ("Environment", SpendData(Amount(29, "GBP"), 1.5)),
      ("Culture", SpendData(Amount(29, "GBP"), 1.5)),
      ("OverseasAid", SpendData(Amount(23, "GBP"), 1.2)),
      ("UkContributionToEuBudget", SpendData(Amount(19, "GBP"), 1))
    ),
