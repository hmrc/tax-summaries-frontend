...
class PortalUserTest extends UnitSpec with OneServerPerSuite with OneBrowserPerSuite with HtmlUnitFactory with MockitoSugar  {
  ...
  "Logging in as a portal user" should {
    ...
    "show the 'exit tax summaries' link on the income before tax page" in  {
      ...
      document.select("#global-breadcrumb li:nth-child(4)").toString should include("<strong>Total income</strong>")
    }
    ...
    "show the 'exit tax summaries' link on the nics page" in  {
      ...
      document.select("#global-breadcrumb li:nth-child(4)").toString should include("<strong>Income Tax and National Insurance</strong>")
    }
    ...
    "show the 'exit tax summaries' link on the tax free amount page" in  {
      ...
      val fakeViewModel = new Allowances(2014, utr, amount, amount, amount, "", "", "")
      ...
      document.select("#global-breadcrumb li:nth-child(4)").toString should include("<strong>Tax-free amount</strong>")
    }
    ...
    "show the 'exit tax summaries' link on the total income tax page" in  {
      ...
      val fakeViewModel = new TotalIncomeTax(2014, utr, amount, amount, amount, amount, amount, amount, amount, amount,
        amount, amount, amount, amount, amount, amount, amount, amount, amount, rate, rate, rate, rate, rate,
        rate, rate, "", "", "")
      ...
      document.select("#global-breadcrumb li:nth-child(4) a").text should include("Income Tax and National Insurance")
