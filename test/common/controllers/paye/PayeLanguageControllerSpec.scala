...
class PayeLanguageControllerSpec extends ControllerBaseSpec {
  ...
  val fakeRequest: FakeRequest[AnyContentAsEmpty.type] =
    FakeRequest().withHeaders(("Referer", common.controllers.routes.ErrorController.notAuthorised.url))
  val redirectLocationUrl: String                      = common.controllers.routes.ErrorController.notAuthorised.url
