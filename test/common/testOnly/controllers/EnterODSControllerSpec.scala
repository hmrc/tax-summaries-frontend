...
import common.testOnly.models.{CountryAndODSValues, SAODSModel}
  ...
  "onSubmit" must {
    "redirect when request valid and add in any missing values with order as per fields list" in {
      ...
      redirectLocation(result) mustBe Some(
        common.testOnly.controllers.routes.DisplayPTAController.onPageLoad(currentTaxYearSA, utr).url
      )
