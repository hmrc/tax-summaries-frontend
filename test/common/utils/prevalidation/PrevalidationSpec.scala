...
package common.utils.prevalidation

import play.api.data.Form
import play.api.data.Forms._
import common.utils.TaxsUnitTestTraits
import common.utils.prevalidation.CaseOption.CaseOption
import common.utils.prevalidation.TrimOption.TrimOption
import common.utils.prevalidation.prevalidation._
...
class PrevalidationSpec extends TaxsUnitTestTraits {
  ...
  object DummyForm {
    ...
    val dummyForm: Form[DummyData] = Form[DummyData](
      mapping(
        "string1" -> text
      )(DummyData.apply)(d => Some(d.string1))
    )
