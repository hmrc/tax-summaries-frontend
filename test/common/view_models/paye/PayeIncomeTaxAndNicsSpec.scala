  ...
  "PayeYourIncomeAndTaxesData" must {
    ...
    "transform to view model with all tax band rates and all adjustments" in {
      ...
      val expectedViewModel = PayeIncomeTaxAndNics(
        ...
        List(
          TaxBand("basic_rate_income_tax", Amount(3000, "GBP"), Amount(480, "GBP"), Rate("21%")),
          TaxBand("higher_rate_income_tax", Amount(20150, "GBP"), Amount(3030, "GBP"), Rate("20%")),
          TaxBand("ordinary_rate", Amount(29430, "GBP"), Amount(5080, "GBP"), Rate("19%")),
